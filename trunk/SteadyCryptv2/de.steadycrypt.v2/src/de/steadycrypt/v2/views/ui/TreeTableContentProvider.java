...
public class TreeTableContentProvider implements ITreeContentProvider, IDeltaListener {
	...
	*/
	 ...
	 * from each child folder of the given folder. */
	 ...
	 * to each child folder of the given folder. */
	...
	public Object[] getChildren(Object parentElement) {
		if(parentElement instanceof EncryptedFolder) {
			EncryptedFolder folder = (EncryptedFolder)parentElement;
			return concat(folder.getFolders().toArray(), 
					folder.getFiles().toArray());
		}
		return EMPTY_ARRAY;
	}
